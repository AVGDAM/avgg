...
import { BookHeart, FileText, Brain, Lightbulb, CheckCircle } from "lucide-react";

export const metadata: Metadata = {
  title: "Recursos de Autoayuda Psicológica - Herramientas Prácticas",
  description: "Recursos gratuitos de autoayuda: diario de emociones, registro de pensamientos, mindfulness guiado y técnicas de afrontamiento.",
  keywords: ["diario emociones", "registro pensamientos", "mindfulness", "técnicas afrontamiento"],
};

const resources = [
  {
    title: "Diario de Emociones Online",
    description: "Herramienta digital para registrar y comprender tus emociones diarias. Identifica patrones y mejora tu autoconocimiento emocional.",
    icon: BookHeart,
    href: "/diario-emociones",
    color: "from-rose-500 to-pink-500",
    features: ["Tracker diario", "Identificación de patrones", "Gráficos de evolución"],
    popular: true,
  },
  {
    title: "Registro de Pensamientos (CBT)",
    description: "Basado en Terapia Cognitivo-Conductual. Identifica pensamientos automáticos negativos y aprende a reestructurarlos.",
    icon: FileText,
    href: "/registro-pensamientos",
    color: "from-blue-500 to-cyan-500",
    features: ["Método CBT validado", "Análisis de distorsiones", "Reestructuración cognitiva"],
    popular: true,
  },
  {
    title: "Mindfulness Guiado",
    description: "Ejercicios de atención plena paso a paso para reducir el estrés y aumentar tu presencia en el momento actual.",
    icon: Brain,
    href: "/mindfulness-guiado",
    color: "from-purple-500 to-indigo-500",
    features: ["Ejercicios guiados", "Diferentes duraciones", "Para principiantes y avanzados"],
  },
  {
    title: "Técnicas de Afrontamiento",
    description: "Estrategias prácticas organizadas por situación: ansiedad, tristeza, ira, estrés. Encuentra la herramienta adecuada para cada momento.",
    icon: Lightbulb,
    href: "/tecnicas-afrontamiento",
    color: "from-amber-500 to-orange-500",
    features: ["Por tipo de emoción", "Aplicación inmediata", "Basadas en evidencia"],
  },
];

export default function RecursosAutoayudaPage() {
  return (
    <main className="min-h-screen bg-white dark:bg-slate-800/30">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-20">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl font-bold text-navy dark:text-slate-100 mb-6">
              Recursos de Autoayuda Psicológica
            </h1>
            <p className="text-xl text-muted dark:text-slate-300 max-w-3xl mx-auto mb-8">
              Herramientas prácticas para tu día a día. Gestiona tus emociones, pensamientos y bienestar con recursos basados en terapia psicológica.
            </p>
          </div>
        </div>
      </section>
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-start gap-4 mb-4">
                      <div className={`flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-r ${resource.color} flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform`}>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-white dark:from-slate-900 dark:to-slate-800">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <div className="bg-blue-50 dark:bg-slate-800 border-l-4 border-beige dark:border-blue-gray p-8 rounded-r-2xl mb-8">
            <h3 className="text-2xl font-bold text-navy dark:text-slate-100 mb-4">
              💡 Recuerda
            </h3>
            <p className="text-muted dark:text-slate-300">
              Estos recursos son herramientas de autoayuda complementarias. No sustituyen la terapia profesional, pero pueden ser muy útiles para tu bienestar diario.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-muted dark:text-slate-300 mb-8">
              Si sientes que necesitas apoyo adicional, agenda una consulta para trabajar juntos en tu bienestar.
            </p>
          </div>
