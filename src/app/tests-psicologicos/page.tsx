...
export const metadata: Metadata = {
  title: "Tests Psicológicos Gratuitos - Evaluaciones Validadas | Natalia Chiva",
  description: "Tests psicológicos gratuitos y validados científicamente: ansiedad, depresión, autoestima, estrés laboral y más. Resultados inmediatos.",
  keywords: ["tests psicológicos", "test ansiedad", "test depresión", "evaluación psicológica"],
  alternates: {
    canonical: "https://www.nataliachiva.com/tests-psicologicos",
  },
};
...
const tests = [
  {
    ...
    description: "Test validado científicamente para evaluar tu nivel de ansiedad generalizada.",
    icon: Brain,
    href: "/test-ansiedad",
    duration: "2 min",
  ...
  },
  {
    ...
    description: "Evalúa síntomas de depresión con el cuestionario reconocido internacionalmente.",
    icon: Heart,
    href: "/test-depresion",
    duration: "3 min",
  ...
  },
  {
    ...
    description: "Descubre si estás en riesgo de síndrome de burnout o agotamiento profesional.",
    icon: Briefcase,
  ...
  },
  {
    ...
    description: "Evalúa tu nivel de autoestima con el test más utilizado mundialmente.",
    icon: Smile,
  ...
  },
  {
    ...
    description: "Evaluación integral de tu bienestar emocional y psicológico.",
    icon: CheckCircle,
  ...
  },
  {
    ...
    description: "Evalúa la salud de tu relación de pareja e identifica áreas de mejora.",
    icon: Users,
    href: "/test-pareja",
    duration: "3 min",
...
export default function TestsPsicologicosPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-muted dark:text-slate-300 max-w-3xl mx-auto mb-8">
              Evaluaciones validadas científicamente para conocer tu estado emocional. Todos los tests son gratuitos, confidenciales y ofrecen resultados inmediatos.
            </p>
            <div className="flex flex-wrap justify-center gap-6 text-sm text-muted dark:text-slate-400">
              <div className="flex items-center gap-2">
                ...
                <span>Validados Científicamente</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="h-5 w-5 text-beige dark:text-blue-gray" />
