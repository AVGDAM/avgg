  ...
  return (
    <div className="flex flex-wrap gap-4 justify-center">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 rounded-lg border-2 border-white text-white px-6 py-3 font-semibold transition hover:bg-white hover:text-navy dark:hover:bg-slate-100 dark:hover:text-slate-900"
      >
